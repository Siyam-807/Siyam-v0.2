...
def banner():
	os.system("clear")
	print("")
print("%s      _______ _________          _______  _______ 
print("%s   (  ____ \\__   __/|\     /|(  ___  )(       )
print("%s   | (    \/   ) (   ( \   / )| (   ) || () () |
print("%s   | (_____    | |    \ (_) / | (___) || || || |
print("%s   (_____  )   | |     \   /  |  ___  || |(_)| |
  print("%s       ) |   | |      ) (   | (   ) || |   | |
print("%s   /\____) |___) (___   | |   | )   ( || )   ( |
print("%s   \_______)\_______/   \_/   |/     \||/     \|
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : %sSIYAM                   %s║"%(Z,B,M,Z))
	print("%s║%s  Github   : https://github.com/Siyam-807  %s║"%(Z,B,Z))
	print("%s║%s  Version  : %s0.2                          %s║"%(Z,B,H,Z))
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
...
cookies = {
    'datr': 'wzZXZDHtea4JqfYlhemX0j6I',
    'sb': 'wzZXZC4xoAtzDxOZxv0xXpLp',
    'm_pixel_ratio': '2.75',
    'x-referer': 'eyJyIjoiL2Jvb2ttYXJrcy8%2FcGFpcHY9MCZlYXY9QWZiWTZmTmZDalc5ZV91VjA4WXNMaXU3VXBRdW5nVlU5RGR6QlpWWnQzNzhJRDlsYWFXaWhqZUFnTXUxTXppMlhpTSIsImgiOiIvYm9va21hcmtzLz9wYWlwdj0wJmVhdj1BZmJZNmZOZkNqVzllX3VWMDhZc0xpdTdVcFF1bmdWVTlEZHpCWlZadDM3OElEOWxhYVdpaGplQWdNdTFNemkyWGlNIiwicyI6Im0ifQ%3D%3D',
    'wd': '393x780',
    'fr': '0D8iCqJZ6X2N6S61u.AWUV2fMZbYiYDRwR60LZXdbruts.BkVzbD.12.AAA.0.0.BkV0ph.AWW3-xWFoTA',
}
...
headers = {
    ...
    'referer': 'https://m.facebook.com/bookmarks/?paipv=0&eav=AfbY6fNfCjW9e_uV08YsLiu7UpQungVU9DdzBZVZt378ID9laaWihjeAgMu1Mzi2XiM',
...
response = requests.get(
    'https://m.facebook.com/login.php?next=https%3A%2F%2Fm.facebook.com%2Fhome.php%3Fwtsid%3Drdr_0Wb65Fw9Jybv9Az00&refsrc=deprecated&wtsid=rdr_0Wb65Fw9Jybv9Az00&_rdr',
    cookies=cookies,
    headers=headers,
)
